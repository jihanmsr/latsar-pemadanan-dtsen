...
export default function LandingWorkflow() {
  ...
  return (
    <div className="w-full py-24 px-4 sm:px-8 bg-slate-50 dark:bg-slate-900/50 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative mt-8">
          ...
          <div className="hidden lg:block absolute top-12 left-[10%] right-[10%] h-1 bg-slate-200 dark:bg-slate-800 rounded-full overflow-hidden">
            <div 
              className="h-full bg-gradient-to-r from-blue-500 via-violet-500 to-rose-500 rounded-full w-full"
            />
          </div>
