    ...
    <div className="fixed bottom-24 left-8 z-50 pointer-events-auto scale-110 sm:scale-125 origin-bottom-left">
      ...
      >
        ...
        <motion.div
          ...
          className="absolute -top-20 left-1/2 -translate-x-1/2 w-48 bg-white dark:bg-slate-800 text-slate-800 dark:text-white text-[10px] font-bold px-3 py-2 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 pointer-events-none text-center"
        >
          Halo! Tau nggak? <b>PAKEWA</b> diambil dari bahasa Kaili lho, artinya <b>'Alat'</b> atau <b>'Senjata'</b> untuk mengentaskan kemiskinan! 🚀
