...
export default function PublicNavbar() {
  ...
  return (
    <>
      <nav className={`w-full sticky top-0 z-50 transition-all duration-300 ${scrolled ? 'bg-[#0B1120]/90 backdrop-blur-xl border-b border-slate-800 shadow-lg' : 'bg-[#0B1120] border-transparent'}`}>
