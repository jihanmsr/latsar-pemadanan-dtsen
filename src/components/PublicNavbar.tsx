...
export default function PublicNavbar() {
  ...
  return (
    <>
      <nav className={`w-full sticky top-0 z-50 transition-all duration-300 ${scrolled ? 'bg-slate-900/90 backdrop-blur-xl border-b border-slate-800 shadow-lg' : 'bg-slate-900 border-transparent'}`}>
