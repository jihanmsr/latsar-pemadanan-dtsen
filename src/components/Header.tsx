        ...
        <div className="hidden sm:flex items-center gap-2">
          {user?.role === 'BPS_ADMIN' ? (
            <>
              ...
              <h2 className="text-xl font-bold text-slate-800 dark:text-slate-200 tracking-tight">Dashboard Admin BPS</h2>
            </>
          ) : (
            <>
              <span className="relative flex h-2.5 w-2.5">
              ...
              <h2 className="text-xl font-bold text-slate-800 dark:text-slate-200 tracking-tight">Dashboard Instansi</h2>
            </>
          )}
        </div>
      </div>
