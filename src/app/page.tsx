          ...
          >
            ...
            <div className="relative w-full max-w-lg aspect-square">
               ...
               <div className="relative w-full h-full">
                 ...
                 <motion.div 
                    animate={{ y: [-15, 10, -15], rotate: [-2, 1, -2] }}
                    transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }}
                    className="absolute top-16 -left-8 sm:-left-16 z-40 bg-slate-900/95 backdrop-blur-xl p-4 rounded-2xl shadow-2xl border border-blue-500/40 font-mono text-[10px] sm:text-xs text-blue-300"
                 >
                   <div className="flex items-center gap-2 mb-2 border-b border-blue-500/30 pb-2">
                     ...
                     <span className="text-slate-500 tracking-wider">TERMINAL</span>
                   </div>
                   <div className="animate-pulse">&gt; SYS_CONNECT (BPS_SULTENG)</div>
                   <div>&gt; SYNC_DTSEN_DATA...</div>
                   <div className="text-emerald-400 font-bold mt-1">&gt; STATUS: MATCHED 99.8%</div>
                 </motion.div>
